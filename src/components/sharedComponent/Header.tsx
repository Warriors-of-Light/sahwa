...
import logo from "@/assets/sahwa.svg"
...
export const Header = ()=>{
    return <nav className="flex justify-between items-center w-full border py-3 pr-[80px]">
        <div className="w-[500px] flex justify-center items-center gap-10">
            <div className="flex w-full justify-center items-center relative border-r-2 pr-2">
                <div className="px-3 py-1 rounded-[20px] border rounded-r-none">Lvl 21</div>
                <div className="radial-progress text-[#E83526] absolute top-[-2px] right-[14px]" style={{ "--value": "70", "--size": "2.5rem", "--thickness": "4px" }} role="progressbar">
                    <Image src={user} alt="user logo"/>
                </div>
            </div>
            <div className="flex justify-between items-center gap-3">
                <Image src={notification} alt="notification"/>
                <div className="bg-[#EDEFF1] px-2 rounded-[20px] flex justify-between items-center gap-2 w-[100px]">
                    <span className="font-bold">1582</span>
                    <Image className="w-[30px] h-[30px] mt-2" src={badge} alt="badge"/>
                </div>
            </div>
